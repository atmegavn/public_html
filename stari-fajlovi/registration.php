...
if ($dbAccessToken->isTokenEmpty()) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $subject = ' MME-SEE Registratio form';
        $messageBody = '
        ...
        <div
            ...
            <h1 style="font-size: 24px; margin: 0;">MME-SEE Registration Info</h1>
            </div>
            <!-- Content -->
        ...
        $message->setFrom(['your_email@gmail.com' => 'Your Name']);
        $message->setTo(['your_email@gmail.com']);
        $message->setBody($messageBody, 'text/html');
        // Attach the file to the message
        if (!empty($file)) {
            $attachment = Swift_Attachment::fromPath($file['tmp_name'][0]);
            $attachment->setFilename($file['name'][0]);
        ...
        try {
            ...
            $response = array(
                'success' => true,
                'message' => 'Registration is successfull. Thank you for your Registration.'
            );
